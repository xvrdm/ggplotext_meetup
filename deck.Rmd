...
Make a more complex margin: 50px + 6px + 170px. Then crop the bottom margin.

I haven't found a way yet to not create the bottom margin, the `magick::image_border()` seems to only work symetrically
